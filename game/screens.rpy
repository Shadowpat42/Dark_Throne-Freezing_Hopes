        ...
        vbox:
            ...
            hbox:
                ...
                if renpy.variant("pc") or renpy.variant("web"):
                    ...
                    vbox:
                        style_prefix "radio"
                        label _("{b}{color=#000000}Режим экрана{/color}{b}")
                        textbutton _("Оконный") action Preference("display", "window")
                        textbutton _("Полный") action Preference("display", "fullscreen")

                vbox:
                    style_prefix "check"
                    label _("{b}{color=#000000}Пропуск{/color}{b}")
            ...
            hbox:
                ...
                vbox:
                    ...
                    label _("{b}{color=#000000}Скорость текста{/color}{b}")

                    bar value Preference("text speed")

                    label _("{b}{color=#000000}Скорость авточтения{/color}{b}")
                ...
                vbox:
                    ...
                    if config.has_music:
                        label _("{b}{color=#000000}Громкость музыки{/color}{b}")
                    ...
                    if config.has_sound:
                        ...
                        label _("{b}{color=#000000}Громкость звуков{/color}{b}")
                    ...
                    if config.has_voice:
                        label _("{b}{color=#000000}Громкость голоса{/color}{b}")
                    ...
                    if config.has_music or config.has_sound or config.has_voice:
                        ...
                        textbutton _("{b}{color=#000000}Без звука{/color}{b}"):
...
screen keyboard_help():
    ...
    hbox:
        label _("{color=#ff0000}Войти{/color}")
        text _("{color=#000000}Прохождение диалогов, активация интерфейса.{/color}")

    hbox:
        label _("{color=#ff0000}Пробел{/color}")
        text _("{color=#000000}Прохождение диалогов без возможности делать выбор.{/color}")

    hbox:
        label _("{color=#ff0000}Стрелки{/color}")
        text _("{color=#000000}Навигация по интерфейсу.{/color}")

    hbox:
        label _("{color=#ff0000}Esc{/color}")
        text _("{color=#000000}Вход в игровое меню.{/color}")

    hbox:
        label _("{color=#ff0000}CtrlP{/color}")
        text _("{color=#000000}Пропускает диалоги, пока зажат.{/color}")

    hbox:
        label _("{color=#ff0000}Tab{/color}")
        text _("{color=#000000}Включает режим пропуска.{/color}")

    hbox:
        label _("{color=#ff0000}Страница вверху{/color}")
        text _("{color=#000000}Откат назад по сюжету игры.{/color}")

    hbox:
        label _("{color=#ff0000}Страница вниз{/color}")
        text _("{color=#000000}Откатывает предыдущее действие вперёд.{/color}")

    hbox:
        label "{color=#ff0000}H{/color}"
        text _("{color=#000000}Скрывает интерфейс пользователя.{/color}")

    hbox:
        label "{color=#ff0000}S{/color}"
        text _("{color=#000000}Делает снимок экрана.{/color}")

    hbox:
        label "{color=#ff0000}V{/color}"
        text _("{color=#000000}Включает поддерживаемый {a=https://www.renpy.org/l/voicing}синтезатор речи{/a}.{/color}")

    hbox:
        label "{color=#ff0000}Shift+A{/color}"
        text _("{color=#000000}Открывает меню специальных возможностей.{/color}")
...
screen confirm(message, yes_action, no_action):
    ...
    frame:
        ...
        vbox:
            ...
            label ("{i}{color=#000000}Вы уверены что хотите выйти?\nНе сохраненный результат будет утерян{/color}{/i}"):
