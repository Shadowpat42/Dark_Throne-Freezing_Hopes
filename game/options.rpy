...
define config.name = _("{b}{color=#000000}Замерзающие надежды{/color}{b}")
...
define gui.about = _p("""
{color=#000000}Здравствуйте Уважаемая комиссия!
\nНовелла была разработана следующими людьми:
\n1. Владимир Джобиров Джамшедовч (дизайнер/разработчик)
\n2. Андрей Шадрин Алексеевич (тимлид/аналитик)
\n3. Мамаев Степан Алексеевич (геймдизайнер){/color}
""")
...
define config.save_directory = "freezing_hopes-1696695585"
